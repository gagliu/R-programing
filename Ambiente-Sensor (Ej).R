...
Mar29CH1J2S1.X5=base[base$hora=="5" & base$sensor==1 & base$fecha=="2014-03-29" & base$camara=="1" & base$jaula=="2",]
...
Mar29CH1J2S1.Y5=data.frame(sensor=1, camara=1, jaula=2 , hora=5,(t(colMeans(Mar29CH1J2S1.X5[2:5]))),(t(colSums(Mar29CH1J2S1.X5[16:26]))))
...
Mar29CH4J2S1.Y5=data.frame(sensor=1, camara=4, jaula=2 , hora=5,(t(colMeans(Mar29CH4J2S1.X5[2:5]))),(t(colSums(Mar29CH4J2S1.X6[16:26]))))
